...
🚀 Fonctionnement
Capture : Un formulaire n8n récupère le nom et le message du client.
Analyse IA : Un Agent IA (Llama 3 via Groq) analyse le message pour déterminer l'urgence.
Notification : Une alerte personnalisée est envoyée sur Discord avec un badge de priorité (🔴 URGENT ou 🟢 NORMAL).
🛠️ Outils utilisés
